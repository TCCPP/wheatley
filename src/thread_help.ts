...
import { colors, thread_based_help_channel_ids } from "./common";
...
export async function setup_thread_help(_client: Discord.Client) {
    try {
        client = _client;
